...
class SearchList extends Component {
    render() {
        const { ProductData, SearchKey } = this.props;

        // Periksa apakah ProductData adalah array
                ...
                <Container className="text-center" fluid={true}>
                    <div className="breadbody">
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item>
                                <Link to={"/productbysearch/" + SearchKey}>Hasil Pencarian Produk Untuk: {SearchKey}</Link>
                            </Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                    <div className="section-title text-center mb-55 mt-5"><h2>{SearchKey}</h2></div>
                    {[
                        ...
                        <Alert key={variant} variant={variant}>
                           Mohon Maaf Data Produk Tidak Ditemukan
                        </Alert>
                    ))}
                </Container>
            );
